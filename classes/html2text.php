...
function convert($html) {
	...
	if (!$doc->loadHTML($html))
		throw new TitanPress_Html2TextException("Could not load HTML - badly formed?", $html);
...
class TitanPress_Html2TextException extends Exception {
